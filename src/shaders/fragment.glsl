...
vec4 permute(vec4 x){return mod(((x*uTime)+1.0)*x, 289.0);}
...
void main()
{
    ...
    // //pattern 47
    float strength = step(-0.0,cnoise(vUv*4.0));
    ...
    //pattern 50
    // float strength = step(0.00,sin(cnoise(vUv*4.0)*10.0));
